			...
			<div class="row">
				<div class="col-md-6 col-md-offset-3">
					<div class="block text-center">
						<div class="loader" style="margin-left:30%;">
...
h78.747C231.693,100.736,232.77,106.162,232.77,111.694z"></path>
						...
						<p>Your order is on the way! We would be happy to hepl you again!</p>
						<a href="shop-sidebar.php" class="btn btn-main mt-20 check" style="border-radius:40PX;">Continue Shopping</a>
					</div>
				</div>
			</div>
		</div>
